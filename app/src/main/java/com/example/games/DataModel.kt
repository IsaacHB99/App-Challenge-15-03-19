...
class Tablero{
   ...
   * */
    fun gano(player: Ficha): Boolean {
        ...
        if(celdas[2][0]?.estadoCelda == player &&celdas[1][1]?.estadoCelda == player && celdas[0][2]?.estadoCelda == player) win == true
        if(celdas[0][1]?.estadoCelda == player &&celdas[1][1]?.estadoCelda == player && celdas[2][1]?.estadoCelda == player) win == true
        if(celdas[1][0]?.estadoCelda == player &&celdas[1][1]?.estadoCelda == player && celdas[1][2]?.estadoCelda == player) win == true
        if(celdas[0][2]?.estadoCelda == player &&celdas[1][2]?.estadoCelda == player && celdas[2][2]?.estadoCelda == player) win == true
